...
if (location.pathname == '/house-attendance.html' || location.pathname == "/senate-attendance.html" || location.pathname == '/house-party-loyalty.html' || location.pathname == "/senate-party-loyalty.html") {
    ...
    if (location.pathname == '/senate-attendance.html' || location.pathname == '/senate-party-loyalty.html') {
        getData("senate");
    }
    if (location.pathname == '/house-attendance.html' || location.pathname == '/house-party-loyalty.html') {
        getData("house");
    }
...
//Loyalty Tables
if (location.pathname == '/house-party-loyalty.html' || location.pathname == "/senate-party-loyalty.html") {

    var statistics;
    var loyaltyTable;

    if (location.pathname == '/senate-party-loyalty.html') {
        getData("senate");
    }
    if (location.pathname == '/house-party-loyalty.html') {
        getData("house");
    }
